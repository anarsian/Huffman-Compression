 ...
 * Date: 11/18/2013
 * This is the HCTree.hpp class file
 * It contains the methods to be implemented
 * */
...
private:
   ...
   void helpMe(HCNode* curr, ofstream& out) ;
   void helpMeNew(HCNode* curr, BitOutputStream& out);
